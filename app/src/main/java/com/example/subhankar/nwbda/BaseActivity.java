...
/**
 * Created by subhankar on 1/21/2016.
 */
    ...
    private void goToNavDrawerItem(int item) {
        switch (item) {
            ...
            case R.id.registration_details:
                startActivity(new Intent(this, RegistrationDetails.class));
                break;
            case R.id.about_srm:
                startActivity(new Intent(this, AboutSrm.class));
                break;
            case R.id.about_swe:
                startActivity(new Intent(this, AboutSwe.class));
                break;
            case R.id.about:
